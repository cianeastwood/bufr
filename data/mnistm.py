"""
From https://github.com/eriklindernoren/PyTorch-GAN/blob/master/implementations/cogan/mnistm.py
"""
...
class MNISTM(data.Dataset):
    ...
    def __init__(self, root, mnist_root="./datasets", train=True, transform=None, target_transform=None,
                 download=False):
